...
COPY ./target/JAN-Comment-0.0.1-SNAPSHOT.jar ./comment-service.jar
...
ENV MOGODB_URI='mongodb+srv://RivS:TelranJava47@cluster0.swrelql.mongodb.net/teltan?retryWrites=true&w=majority'

# Запускаем Java-приложение при старте контейнера
CMD ["java", "-jar", "/rivstas/comment-service.jar", "--server.port=8082", "--server.address=0.0.0.0"]
